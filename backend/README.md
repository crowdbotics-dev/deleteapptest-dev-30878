...
## Project Structure
    ...
    ├── deleteapptest_dev_30878  # Django project configurations
...
1. Clone this repo and `cd deleteapptest_dev_30878`
...
2. Clone this repo and `cd deleteapptest_dev_30878`
